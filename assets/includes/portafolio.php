    ...
    <div class="container">
        ...
        <div class="text-center">
            <ul class="portfolio-filter">
                ...
                <li><a href="#" data-filter=".punto">Punto de Venta</a></li>
                <li><a href="#" data-filter=".seguridad">Camaras de Seguridad</a></li>
                <li><a href="#" data-filter=".escaner">Codigo de barra</a></li>
            </ul><!--/#portfolio-filter-->
        </div>
